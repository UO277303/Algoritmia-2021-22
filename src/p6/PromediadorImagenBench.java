...
public class PromediadorImagenBench {
	...
	private static String REAL_IMG = Paths.get("").toAbsolutePath().toString() + "/p6/einstein_1_256.png";
	private static String BAD_IMG = Paths.get("").toAbsolutePath().toString() + "/p6/einstein_1_256.png";
	private static String OUT_DIR_G = Paths.get("").toAbsolutePath().toString() + "/p6/out_g/";
	private static String OUT_DIR_B = Paths.get("").toAbsolutePath().toString() + "/p6/out_bt";
