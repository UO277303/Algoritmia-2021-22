...
public class PromediadorImagenBench {
	...
	private static String REAL_IMG = Paths.get("").toAbsolutePath().toString() + "files\\einstein_1_256.png";
	private static String BAD_IMG = Paths.get("").toAbsolutePath().toString() + "files\\einstein_1_256.png";
