...
public class Imagen {
	...
	/**
	 * Constructor para generar una imagen vacia (los niveles de gris de todos los
	 * píxeles a zero)
	 * 
	...
	/**
	 * Permite añadir la señal (niveles de gris para cada píxel) de otra imagen La
	 * suma de dos imágenes cero-normalizadas dan como resultado otra imagen
	 * cero-nomalizada La suma de dos imágenes cero-normalizadas es un promedio en
	...
	/**
	 * @region indica que región hay que suprimir (por los píxeles a 0): 0-arriba,
	 *         1-abajo, 2-izquierda and 3-derecha
	 */
	...
	/**
	 * Calcula la Correlación cruzada cero normalizada (Zero Mean Normalized
	 * Cross-Correlation, ZNCC) con respecto a otra image
	 * 
	...
	/**
	 * @return una matriz de enteros para representar los píxeles en el rango [0,
	 *         255] (byte sin signo)
	 */
	...
	/**
	 * Fuerza a que los valores de los píxeles estén zero nomralizados (media 0 y
